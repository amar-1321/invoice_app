...
function AddCustomer(props) {
    ...
    <Modal {...props} aria-labelledby="contained-modal-title-vcenter">
      ...
      <Modal.Body className="grid-example">
        <Container>
          ...
          value={CustomerData.cus_name}
          onChange={(e) =>
            setCustomerData({ ...CustomerData, cus_name: e.target.value })
          }
        />
            </Col>
          ...
          aria-describedby="basic-addon2"
          value={CustomerData.cust_type}
          onChange={(e) =>
            setCustomerData({ ...CustomerData, cust_type: e.target.value })
          }
        >
  ...
  <option value="Puducherry">Puducherry</option>
            ...
            <Form.Select aria-label="Default select example"
             ...
             onChange={(e) =>
               setCustomerData({ ...CustomerData, statecode: e.target.value })
             }
            >
...
<option value="98-Other Territory">98-Other Territory</option>
        ...
        />
          ...
          aria-label="Recipient's username"
          aria-describedby="basic-addon2"
          value={CustomerData.cperson}
          onChange={(e) =>
            setCustomerData({ ...CustomerData, cperson: e.target.value })
          }
        />
            </Col>
          </Row>
          ...
          onChange={(e) =>
            setCustomerData({ ...CustomerData, gstno: e.target.value })
          }
        />
          ...
          onChange={(e) =>
            setCustomerData({ ...CustomerData, panno: e.target.value })
          }
        />
