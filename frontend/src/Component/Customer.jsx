...
function Customer() {
    ...
    useEffect(() => {
      ...
      .then(response => {
        ...
        setCustomer(prevData => prevData.filter(customer => customer.id !== id));
      })
      .catch(error => {
          ...
          .then(response => {
            ...
            setCustomer(prevcustomer =>
              prevcustomer.map(customer =>
                customer.id === selectedRow.id ? selectedRow : customer
              )
            );
            handleCloseModal();
          })
  ...
  return (
    ...
    <div>     
        ...
        <div className='heading_bill' >
          <span className='head-text'><img src={arrowIcon} alt="" /> Customer List</span>
          <Button 
          type='submit'
          href='/register'
          style={{
      ...
      <Modal show={!!selectedRow} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          ...
          value={selectedRow.cus_name}
          onChange={(e) =>
            setSelectedRow({ ...selectedRow, cus_name: e.target.value })
          }
        ...
        />
          ...
          aria-label="Recipient's Customer Type"
          aria-describedby="basic-addon2"
          value={selectedRow.cust_type}
          onChange={(e) =>
            setSelectedRow({ ...selectedRow, cust_type: e.target.value })
          }
        >
...
<option value="98-Other Territory">98-Other Territory</option>
        ...
        />
          ...
          aria-describedby="basic-addon2"
          value={selectedRow.cperson}
          onChange={(e) =>
            setSelectedRow({ ...selectedRow, cperson: e.target.value })
          }
        />
